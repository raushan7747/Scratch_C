...
int main()
{
    ...
    while(i < 5) { // while loop execution block starts from here
        printf("\nPlaying a game 5 times only", i+1);
        i++; // the work,  what we want cahnges in each execution
    }
    ...
    */
    ...
    } while (num < 11); // after execution above, check while the condition is true of false
